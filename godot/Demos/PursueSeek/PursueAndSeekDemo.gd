...
@export (float, 0, 2000, 40) var linear_speed_max := 120.0: set = set_linear_speed_max
@export (float, 0, 2000, 20) var linear_accel_max := 10.0: set = set_linear_accel_max
@export (float, 0, 5, 0.1) var predict_time := 1.0: set = set_predict_time
