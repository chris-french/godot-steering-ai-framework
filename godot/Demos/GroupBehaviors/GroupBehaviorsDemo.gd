...
@export (float, 0, 2000, 40.0) var linear_speed_max := 600.0: set = set_linear_speed_max
@export (float, 0, 9000, 2.0) var linear_accel_max := 40.0: set = set_linear_accel_max
@export (float, 0, 300, 2.0) var proximity_radius := 140.0: set = set_proximity_radius
@export (float, 0, 200000, 250) var separation_decay_coefficient := 2000.0: set = set_separation_decay_coef
@export (float, 0, 2, 0.1) var cohesion_strength := 0.1: set = set_cohesion_strength
@export (float, 0, 10, 0.2) var separation_strength := 1.5: set = set_separation_strength
