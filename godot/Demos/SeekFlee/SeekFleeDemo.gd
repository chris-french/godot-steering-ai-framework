...
@export (Mode) var behavior_mode := Mode.SEEK: set = set_behavior_mode
@export (float, 0, 1000, 30) var linear_speed_max := 200.0: set = set_linear_speed_max
@export (float, 0, 2000, 40) var linear_accel_max := 10.0: set = set_linear_accel_max
@export (float) var player_speed := 600.0: set = set_player_speed
