...
@export (float, 0, 1000, 40) var linear_speed_max := 350.0: set = set_linear_speed_max
@export (float, 0, 4000, 2) var linear_acceleration_max := 40.0: set = set_linear_accel_max
@export (float, 0, 500, 10) var proximity_radius := 140.0: set = set_proximity_radius
